    ...
    <div className="border-b-2 border-accent/30 py-2 px-4 text-center relative z-10 overflow-hidden !bg-[#e19a94]">
      <div className="absolute top-0 left-0 right-0 pointer-events-none">
        <div className="flex justify-around">
          ...
          <Droplets className="w-4 h-4 text-white/30 -mt-1" />
          <Gem className="w-5 h-5 text-accent/40 -mt-2 fill-current" />
          <Heart className="w-5 h-5 text-white/40 -mt-2" />
          <Droplets className="w-4 h-4 text-white/30 -mt-1" />
          <Gem className="w-6 h-6 text-accent/40 -mt-2 fill-current" />
          <Heart className="w-5 h-5 text-white/40 -mt-2" />
        </div>
      </div>
