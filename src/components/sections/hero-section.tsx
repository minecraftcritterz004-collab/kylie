  ...
  return (
    <div className="max-w-lg mx-auto text-center">
      ...
      <h1 className="text-lg md:text-xl font-bold text-black mb-1.5  px-2 relative -mt-4">
        <Gem className="w-2.5 h-2.5 text-[#966c76] absolute -top-0.5 left-3 animate-pulse" />
        Unlock{' '}
        <span className="inline-flex items-center gap-1 !text-[#966c76]">
          Kylie Cosmetics Rewards
          <Gift className="w-4 h-4 inline-block !text-[#966c76]" />
        </span>
        <Heart className="w-2.5 h-2.5 text-[#966c76] absolute -bottom-0.5 right-3 animate-pulse" />
      </h1>

      <p className="text-xs md:text-sm text-black mb-2 font-medium  px-2 relative">
        <Sparkles className="w-2.5 h-2.5 text-[#966c76] inline-block mr-1 animate-pulse" />
        ...
        <Sparkles className="w-2.5 h-2.5 text-[#966c76] inline-block ml-1 animate-pulse" />
      </p>
    </div>
  );
};
